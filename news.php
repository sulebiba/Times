    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
               ...
               $select=mysqli_query($db,"SELECT * FROM post_title ORDER BY id desc LIMIT $start_from,$num_per_page");
                while($row=mysqli_fetch_array($select)){
        ...
        <?php
        $q=mysqli_query($db,"SELECT * FROM post_title");
        $total_q=mysqli_num_rows($q);
        $total_page=ceil($total_q/$num_per_page);
        
        if($page>1){
            
          echo"<a href='news.php?page=".($page-1)."' class='btn btn-danger'>previous</a>";   
        }
        ...
        if($i>$page){
          ...
          echo"<a href='news.php?page=".($page+1)."' class='btn btn-danger'>next</a>";   
        }
        ?>
