    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Videos in Post</div>
                </div>
               <?php
                
               $select=mysqli_query($db,"SELECT * FROM post_title ORDER BY id desc");
                while($row=mysqli_fetch_array($select)){
               ...
               echo"<div class='row pb-4'>
                    ...
                    <div class='col-md-7 animate-box'>
                        ...
                        $date </a>
                        <div class='fh5co_consectetur'><a href='single.php?date=$date&headline=$headline&token=$token'>Video, Pictures and Contents in this Section Click Link to View Video
                        </a></div>
                    </div>
                </div>";
                }
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom pt-3 py-2 mb-4">Sport</div>
                </div>
                <?php
                ...
                echo"<div class='row pb-3'>
                    <div class='col-5 align-self-center'>
                        <a href='single.php?date=$date&headline=$headline&token=$token'><img src='posts/$token'  class='fh5co_most_trading'/></a>
                    </div>
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">World News</div>
        </div>
        <div class="owl-carousel owl-theme" id="slider2">
            
             <?php
                
                 $select=mysqli_query($db,"SELECT * FROM post_title WHERE Category LIKE '%World News%' ORDER BY id desc LIMIT 0,4");
                while($row=mysqli_fetch_array($select)){
                    $headline=$row['headline'];
                    $author=$row['author'];
                    $date=$row['date'];
